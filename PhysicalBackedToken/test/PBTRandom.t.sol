...
// Interfaces
import "../src/interface/IPBT.sol";
// Mocks
import "../src/mock/PBTRandomMock.sol";
...
contract PBTRandomTest is Test {
    ...
    function testIsChipSignatureForToken() public withSeededChips {
        ...
        assertEq(
            pbt.isChipSignatureForToken(tokenId, payload, signature),
            true
        );
    ...
    function testTransferTokenWithChip(bool useSafeTransfer)
        public
        withSeededChips
    {
        vm.roll(blockNumber + 1);
    ...
    function testGetTokenDataForChipSignature() public withSeededChips {
        ...
        PBTRandom.TokenData memory td = pbt.getTokenDataForChipSignature(
            signature,
            blockNumber
        );
        assertEq(td.set, true);

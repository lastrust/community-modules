...
contract PBTTest is Test {
    ...
    function setUp() public {
        pbt = new PBTMock("PBTSimple", "PBTS");
    }
    ...
    function testIsChipSignatureForToken()
        public
        setChipTokenMapping
        mintedTokens
    {
        ...
        assertEq(
            pbt.isChipSignatureForToken(tokenId1, payload, chipSignature),
            true
        );
    }
    ...
    function testGetTokenDataForChipSignatureInvalidBlockNumber()
        public
        setChipTokenMapping
    {
        vm.roll(blockNumber);
    ...
    function testGetTokenDataForChipSignatureBlockNumTooOld()
        public
        setChipTokenMapping
    {
        // Create inputs
    ...
    function testGetTokenDataForChipSignature() public setChipTokenMapping {
        ...
        vm.prank(user1);
        PBTSimple.TokenData memory td = pbt.getTokenDataForChipSignature(
            chipSignature,
            blockNumber
        );
    ...
    function testGetTokenDataForChipSignatureInvalid()
        public
        setChipTokenMapping
    {
        // Change block number to the next block to set blockHash(blockNumber)
